<ul class="breadcrumb">
   <li>
      <i class="icon-home"></i>
      <a href="/admin"><?php echo __("Home"); ?></a> 
        ...
        <table class="table table-striped table-bordered bootstrap-datatable datatable">
            <thead>
               <tr>
                    ...
                    <th><?php echo $this->Paginator->sort('created',__('Ngày đặt hàng')); ?></th>
                    <th><?php echo $this->Paginator->sort('brow_date',__('Ngày mượn')); ?></th>
                    <th><?php echo $this->Paginator->sort('pay_date',__('Ngày trả')); ?></th>
            ...
            ?>
               <tr>
                    <td><?php echo $i; ?>&nbsp;</td>
                    <td><?php echo h($order['Admin']['username']); ?>&nbsp;</td>
                    <td><?php echo h($order['Admin']['phone']); ?>&nbsp;</td>
                    <td <?php echo ($order['Order']['status']==0)?'style="background-color:yellow;"':''?>><?php echo ($order['Order']['status']==0)?"Mới đặt thuê":"Đã giao hàng"; ?>&nbsp;
                    </td>                    
                    <td><?php echo h($order['Order']['created']); ?>&nbsp;</td>
                    <td><?php echo h($order['Order']['brow_date']); ?>&nbsp;</td>
                    <td><?php echo h($order['Order']['pay_date']); ?>&nbsp;</td>
